import { Text, Container, Heading, Button, Grid, GridItem, Flex, Image, Box, LinkOverlay, LinkBox, ButtonGroup, useMediaQuery } from '@chakra-ui/react'
      ...
      <Container maxW="container.xl" pb={{ base: "24", md: "0" }}>
        <Flex width="100%" flexFlow={{ base: 'column-reverse', md: 'row' }} alignItems={{ md: 'center' }} p="0">
          <Box maxW={{ base: '100%', md: '50%' }} textAlign="left">
            ...
            <Text fontSize="lg" pt="4" lineHeight="200%" color="gray.500">
